    ...
    for (var t = [], i = arguments.length - 1; i-- > 0;) {
      ...
      var e = this.params,
        ...
        var E, T;"string" == typeof b && b.indexOf("%") >= 0 && (b = parseFloat(b.replace("%", "")) / 100 * s), this.virtualSize = -b, a ? n.css({ marginLeft: "", marginTop: "" }) : n.css({ marginRight: "", marginBottom: "" }), e.slidesPerColumn > 1 && (E = Math.floor(o / e.slidesPerColumn) === o / this.params.slidesPerColumn ? o : Math.ceil(o / e.slidesPerColumn) * e.slidesPerColumn, "auto" !== e.slidesPerView && "row" === e.slidesPerColumnFill && (E = Math.max(E, e.slidesPerView * e.slidesPerColumn)));for (var S, C = e.slidesPerColumn, M = E / C, z = M - (e.slidesPerColumn * M - o), k = 0; k < o; k += 1) {
          T = 0;var P = n.eq(k);if (e.slidesPerColumn > 1) {
            ...
            if ("auto" === e.slidesPerView) {
              var D = t.getComputedStyle(P[0], null),
                  ...
                  A = P[0].style.webkitTransform;O && (P[0].style.transform = "none"), A && (P[0].style.webkitTransform = "none"), T = this.isHorizontal() ? P[0].getBoundingClientRect().width + parseFloat(D.getPropertyValue("margin-left")) + parseFloat(D.getPropertyValue("margin-right")) : P[0].getBoundingClientRect().height + parseFloat(D.getPropertyValue("margin-top")) + parseFloat(D.getPropertyValue("margin-bottom")), O && (P[0].style.transform = O), A && (P[0].style.webkitTransform = A), e.roundLengths && (T = Math.floor(T));
          ...
          S = [];for (var G = 0; G < l.length; G += 1) {
            l[G] < this.virtualSize + l[0] && S.push(l[G]);
          }l = S;
        }if (!e.centeredSlides) {
          S = [];for (var H = 0; H < l.length; H += 1) {
            l[H] <= this.virtualSize - s && S.push(l[H]);
      ...
      void 0 === e && (e = this.params.speed), void 0 === t && (t = !0);var s = this.params,
        ...
        return Math.floor(e);
          ...
          c = (n.map(function (e) {
        return Math.floor(e);
      }), r[p.indexOf(h)], r[p.indexOf(h) - 1]);return void 0 !== c && (l = n.indexOf(c)) < 0 && (l = this.activeIndex - 1), this.slideTo(l, e, t, i);
