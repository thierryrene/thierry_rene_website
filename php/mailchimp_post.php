...
$apikey = '98e487719c927f0ada5ecaecc77530a5-us15';
$listid = '7ed246ebf1';
$server = 'us15.';
...
if ($debug) {
	echo "*Robot voice* : Bleep bleep. Debugging is on master.";
}

if (!isset($email)) {
	echo "*Robot voice*: No email master, I don't know what to do now.";
}
