		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="footer-col col-md-4 hidden-xs">
					...
					<!--<div class="list-icons">-->
					<!--  <p class="label label-success">Disponível para projetos Freela.</p>-->
					<!--</div>-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12 animsition">
					<h5>Copyright &copy; <br class="visible-xs animsition-link"><a style="color:snow; text-decoration:none;" href="/?drop=1"><?= $seoData['author']; ?></a> 2009 / <?= date('Y'); ?></h5>
				</div>
			</div>
