...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Create a New User
      <small>enter with data to create a new user to admin</small>
    </h1>
    <ol class="breadcrumb">
  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">List Inactive Users</h3>
...
<footer class="main-footer">
  ...
  <strong>Copyright &copy; 2014-2016 <a href="//thierryrenewebdev.com">Thierry Rene</a>.</strong> All rights reserved.
</footer>
